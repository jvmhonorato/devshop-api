...
var CategoryResolver = /** @class */ (function () {
    ...
    __decorate([
        (0, graphql_1.Query)(function () { return [category_1.CategoryPublic]; }, { name: 'getAllCategories' })
    ], CategoryResolver.prototype, "getAllCategories");
    __decorate([
        (0, graphql_1.Query)(function (returns) { return category_1.CategoryPublic; }, { name: 'getCategoryById' }),
        __param(0, (0, graphql_1.Args)('id'))
    ], CategoryResolver.prototype, "getCategoryById");
    __decorate([
    ...
    __decorate([
        ...
        __param(0, (0, graphql_1.Args)('id'))
    ], CategoryResolver.prototype, "deleteCategory");
